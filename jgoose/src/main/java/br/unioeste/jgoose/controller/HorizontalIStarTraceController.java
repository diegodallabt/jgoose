...
public class HorizontalIStarTraceController extends AbstractAction{
    ...
    public static TokensTraceability getTokensTraceability(){
        ...
        switch (indice) {
            case 0: //Informação Externa x Informação Externa
                ...
                Matriz matriz0 = new Matriz(title, tokensTraceIStar.getInformcaoExterna().size(),
                        tokensTraceIStar.getInformcaoExterna().size(),
            ...
            case 1: //Informação Externa x Informação Organizacional
                ...
                Matriz matriz1 = new Matriz(title, tokensTraceIStar.getInformcaoExterna().size(),
                        tokensTraceIStar.getInformacaoOrg().size(),
                        HorizontalBPMNTraceController.getTokensTraceability().getInformcaoExterna(),
            ...
            case 2: //Informação Organizacional x Informação Organizacional
                ...
                Matriz matriz2 = new Matriz(title, tokensTraceIStar.getInformacaoOrg().size(),
                        tokensTraceIStar.getInformacaoOrg().size(),
                        HorizontalBPMNTraceController.getTokensTraceability().getInformacaoOrg(),
                        HorizontalBPMNTraceController.getTokensTraceability().getInformacaoOrg(),
                        true);
            ...
            case 3: //Informação Organizacional x Requisitos
                ...
                Matriz matriz3 = new Matriz(title, tokensTraceIStar.getInformacaoOrg().size(),
                        tokensTraceIStar.getRequisitos().size(),
                        HorizontalBPMNTraceController.getTokensTraceability().getInformacaoOrg(),
            ...
            case 4: //Objetivo do Sistema x Objetivo do Sistema
                ...
                Matriz matriz4 = new Matriz(title, tokensTraceIStar.getObjetivoSistema().size(),
                        tokensTraceIStar.getObjetivoSistema().size(),
            ...
            case 5: //Objetivo do Sistema x Requisitos
                ...
                Matriz matriz5 = new Matriz(title, tokensTraceIStar.getObjetivoSistema().size(),
                        tokensTraceIStar.getRequisitos().size(),
                        HorizontalBPMNTraceController.getTokensTraceability().getObjetivoSistema(),
                        HorizontalBPMNTraceController.getTokensTraceability().getRequisitos(),
                        false);
            ...
            case 6: //Stakeholder x Stakeholder
                ...
                Matriz matriz6 = new Matriz(title, tokensTraceIStar.getStakeholders().size(),
                        tokensTraceIStar.getStakeholders().size(),
            ...
            case 7: //Stakeholder x Requisitos
                ...
                Matriz matriz7 = new Matriz(title, tokensTraceIStar.getStakeholders().size(),
                        tokensTraceIStar.getRequisitos().size(),
                        HorizontalBPMNTraceController.getTokensTraceability().getStakeholders(),
                        HorizontalBPMNTraceController.getTokensTraceability().getRequisitos(),
                        false);
            ...
            case 8: //Requisitos x Requisitos
                ...
                Matriz matriz8 = new Matriz(title, tokensTraceIStar.getRequisitos().size(),
                        tokensTraceIStar.getRequisitos().size(),
                        HorizontalBPMNTraceController.getTokensTraceability().getRequisitos(),
                        HorizontalBPMNTraceController.getTokensTraceability().getRequisitos(),
                        true);
            ...
            case 9: //Requisitos x Informação Externa
                ...
                Matriz matriz9 = new Matriz(title, tokensTraceIStar.getRequisitos().size(),
                        tokensTraceIStar.getInformcaoExterna().size(),
                        HorizontalBPMNTraceController.getTokensTraceability().getRequisitos(),
                        HorizontalBPMNTraceController.getTokensTraceability().getInformcaoExterna(),
                        false);
            ...
            case 10: //Objetivo do Sistema x Informação Organizacional
                ...
                Matriz matriz10 = new Matriz(title, tokensTraceIStar.getObjetivoSistema().size(),
                        tokensTraceIStar.getInformacaoOrg().size(),
                        HorizontalBPMNTraceController.getTokensTraceability().getObjetivoSistema(),
                        HorizontalBPMNTraceController.getTokensTraceability().getInformacaoOrg(),
                        false);
            ...
            case 11: //Objetivo do Sistema x Objetivo do Sistema
                title = " ← <AGREGAÇÃO> Objetivo do Sistema x Objetivo do Sistema  <AGREGAÇÃO>";
                Matriz matriz11 = new Matriz(title, tokensTraceIStar.getObjetivoSistema().size(),
                        tokensTraceIStar.getObjetivoSistema().size(),
                        HorizontalBPMNTraceController.getTokensTraceability().getObjetivoSistema(),
                        HorizontalBPMNTraceController.getTokensTraceability().getObjetivoSistema(),
                        true);
    ...
    public static void selectMatriz(int indice) {
        ...
        switch (indice) {
            case 0: //Informação Externa x Informação Externa
                title = " ← <AGREGAÇÃO> Informação Externa x Informação Externa  <AGREGAÇÃO>";
                Matriz m0 = new Matriz(tokensTraceIStar.getInformcaoExterna().size(), tokensTraceIStar.getInformcaoExterna().size(), title);
                m0.matriz(HorizontalIStarTraceController.getTokensTraceability().getInformcaoExterna(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getInformcaoExterna(), true);//row
                break;
            case 1: //Informação Externa x Informação Organizacional
                title = " ← <REC> Informação Externa x Informação Organizacional <REC>";
                Matriz m1 = new Matriz(tokensTraceIStar.getInformcaoExterna().size(), tokensTraceIStar.getInformacaoOrg().size(), title);
                m1.matriz(HorizontalIStarTraceController.getTokensTraceability().getInformcaoExterna(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getInformacaoOrg(), false);//row          

                break;
            case 2: //Informação Organizacional x Informação Organizacional
                title = " ← <AGREGAÇÃO> Informação Organizacional x Informação Organizacional  <AGREGAÇÃO>";
                Matriz m2 = new Matriz(tokensTraceIStar.getInformacaoOrg().size(), tokensTraceIStar.getInformacaoOrg().size(), title);
                m2.matriz(HorizontalIStarTraceController.getTokensTraceability().getInformacaoOrg(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getInformacaoOrg(), true);//row
                break;
            case 3: //Informação Organizacional x Requisitos
                title = " ← <REC> Informação Organizacional x Requisitos  <REC>";
                Matriz m3 = new Matriz(tokensTraceIStar.getInformacaoOrg().size(), tokensTraceIStar.getRequisitos().size(), title);
                m3.matriz(HorizontalIStarTraceController.getTokensTraceability().getInformacaoOrg(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getRequisitos(), false);//row
                break;
            case 4: //Objetivo do Sistema x Objetivo do Sistema
                title = " ← <AGREGAÇÃO> Objetivo do Sistema x Objetivo do Sistema  <AGREGAÇÃO>";
                Matriz m4 = new Matriz(tokensTraceIStar.getObjetivoSistema().size(), tokensTraceIStar.getObjetivoSistema().size(), title);
                m4.matriz(HorizontalIStarTraceController.getTokensTraceability().getObjetivoSistema(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getObjetivoSistema(), true);//row
                break;
            case 5: //Objetivo do Sistema x Requisitos
                title = " ← <SAT> Objetivo do Sistema x Requisitos  <SAT>";
                Matriz m5 = new Matriz(tokensTraceIStar.getObjetivoSistema().size(), tokensTraceIStar.getRequisitos().size(), title);
                m5.matriz(HorizontalIStarTraceController.getTokensTraceability().getObjetivoSistema(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getRequisitos(), false);//row
                break;
            case 6: //Stakeholder x Stakeholder
                title = " ← <AGREGAÇÃO> Stakeholder x Stakeholder  <AGREGAÇÃO>";
                Matriz m6 = new Matriz(tokensTraceIStar.getStakeholders().size(), tokensTraceIStar.getStakeholders().size(), title);
                m6.matriz(HorizontalIStarTraceController.getTokensTraceability().getStakeholders(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getStakeholders(), true);//row
                break;
            case 7: //Stakeholder x Requisitos
                title = " ← <RESP> Stakeholder x Requisitos  <RESP>";
                Matriz m7 = new Matriz(tokensTraceIStar.getStakeholders().size(), tokensTraceIStar.getRequisitos().size(), title);
                m7.matriz(HorizontalIStarTraceController.getTokensTraceability().getStakeholders(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getRequisitos(), false);//row

                break;
            case 8: //Requisitos x Requisitos
                title = " ← <AGREGAÇÃO> Requisitos x Requisitos  <AGREGAÇÃO>";
                Matriz m8 = new Matriz(tokensTraceIStar.getRequisitos().size(), tokensTraceIStar.getRequisitos().size(), title);
                m8.matriz(HorizontalIStarTraceController.getTokensTraceability().getRequisitos(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getRequisitos(), true);//row
                break;
            case 9: //Requisitos x Informação Externa
                title = " ← <REC> Requisitos x Informação Externa  <REC>";
                Matriz m9 = new Matriz(tokensTraceIStar.getRequisitos().size(), tokensTraceIStar.getInformcaoExterna().size(), title);
                m9.matriz(HorizontalIStarTraceController.getTokensTraceability().getRequisitos(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getInformcaoExterna(), false);//row
                break;
            case 10: //Objetivo do Sistema x Informação Organizacional
                title = " ← <REC> Objetivo do Sistema x Informação Organizacional  <REC>";
                Matriz m10 = new Matriz(tokensTraceIStar.getObjetivoSistema().size(), tokensTraceIStar.getInformacaoOrg().size(), title);
                m10.matriz(HorizontalIStarTraceController.getTokensTraceability().getObjetivoSistema(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getInformacaoOrg(), false);//row
                break;
            case 11: //Objetivo do Sistema x Objetivo do Sistema
                title = " ← <SAT> Ator Sistema x Stakeholder  <SAT>";
                Matriz m11 = new Matriz(tokensTraceIStar.getAtorSistema().size(), tokensTraceIStar.getStakeholders().size(), title);
                m11.matriz(HorizontalIStarTraceController.getTokensTraceability().getAtorSistema(),//col
                        HorizontalIStarTraceController.getTokensTraceability().getStakeholders(), true);//row
                break;
        }    
     }
